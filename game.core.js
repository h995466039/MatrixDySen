...
const assetPaths = {
  ...
  gear: 'godot_game/assets/generated/resource-part-gear-v01.png',
  magneticCoil: 'godot_game/assets/generated/resource-part-magneticCoil-v01.png',
  circuitBoard: 'godot_game/assets/generated/resource-part-circuitBoard-v01.png',
  glass: 'godot_game/assets/generated/resource-part-glass-v01.png',
  motor: 'godot_game/assets/generated/resource-part-motor-v01.png',
  turbine: 'godot_game/assets/generated/resource-part-turbine-v01.png',
  particleContainer: 'godot_game/assets/generated/resource-part-particleContainer-v01.png',
  solarSail: 'godot_game/assets/generated/resource-part-solarSail-v01.png',
  structureRocket: 'godot_game/assets/generated/resource-part-structureRocket-v01.png',
  orbitNode: 'godot_game/assets/generated/resource-part-orbitNode-v01.png',
...
const resources = {
  ...
  gear: { label: '齿轮', color: '#d9b77c', image: 'gear', form: 'solid', tier: 1 },
  magneticCoil: { label: '磁线圈', color: '#d783ff', image: 'magneticCoil', form: 'solid', tier: 2 },
  circuitBoard: { label: '电路板', color: '#79d6a2', image: 'circuitBoard', form: 'solid', tier: 2 },
  glass: { label: '玻璃', color: '#9feaff', image: 'glass', form: 'solid', tier: 2 },
  motor: { label: '电动机', color: '#f1a45e', image: 'motor', form: 'solid', tier: 3 },
  turbine: { label: '涡轮机', color: '#c2e0ff', image: 'turbine', form: 'solid', tier: 3 },
  particleContainer: { label: '粒子容器', color: '#f6d86b', image: 'particleContainer', form: 'solid', tier: 4 },
  solarSail: { label: '太阳帆', color: '#f7f0ae', image: 'solarSail', form: 'solid', tier: 4 },
  structureRocket: { label: '结构火箭', color: '#ffbd81', image: 'structureRocket', form: 'solid', tier: 5 },
  orbitNode: { label: '轨道节点', color: '#bff5de', image: 'orbitNode', form: 'solid', tier: 5 }
};
...
const techTree = {
  mainline: [
    { id: 'planetary-logistics', label: '行星物流', short: '物流主干', description: '建立行星级物流网络，研究分拣与长距离运输。', requires: ['foundation'], cube: 'electromagneticCube', cost: 12 },
